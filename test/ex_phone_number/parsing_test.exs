defmodule ExPhoneNumber.ParsingTest do
  ...
  describe ".parse/2" do
    test "NZ number should return correct value #1" do
    ...
    test "NZ number should return correct value #2" do
    ...
    test "NZ number should return correct value #3" do
    ...
    test "NZ number should return correct value #4" do
      {result, phone_number} = parse("03 331 6005", RegionCodeFixture.nz())
    ...
    test "NZ number should return correct value #5" do
    ...
    test "NZ number should return correct value #6" do
    ...
    test "NZ number should return correct value #7" do
    ...
    test "NZ number should return correct value #8" do
    ...
    test "NZ number should return correct value #9" do
    ...
    test "NZ number should return correct value #10" do
    ...
    test "NZ number should return correct value #11" do
    ...
    test "NZ number should return correct value #12" do
    ...
    test "NZ number should return correct value #13" do
    ...
    test "NZ number should return correct value #14" do
    ...
    test "NZ number should return correct value #15" do
    ...
    test "NZ number should return correct value #16" do
      {result, phone_number} = parse("+01164 3 331 6005", RegionCodeFixture.us())
    ...
    test "NZ number should return correct value #17" do
      {result, phone_number} = parse("+0064 3 331 6005", RegionCodeFixture.nz())
    ...
    test "NZ number should return correct value #18" do
    ...
    test "NZ number3 should return correct value" do
    ...
    test "NZ short number should return correct value" do
    ...
    test "DE number should return correct value" do
    ...
    test "JP star number should return correct value" do
    ...
    test "US number2 should return correct value" do
    ...
    test "US local number should return correct value #1" do
    ...
    test "US local number should return correct value #2" do
    ...
    test "US local number should return correct value #3" do
    ...
    test "US local number should return correct value #4" do
    ...
    test "AR numbers should return correct value #1" do
    ...
    test "AR numbers should return correct value #2" do
    ...
    test "AR numbers should return correct value #3" do
    ...
    test "AR numbers should return correct value #4" do
    ...
    test "AR numbers should return correct value #5" do
    ...
    test "AR numbers should return correct value #6" do
    ...
    test "AR numbers should return correct value #7" do
    ...
    test "AR numbers should return correct value #8" do
    ...
    test "AR numbers should return correct value #9" do
    ...
    test "AR numbers should return correct value #10" do
    ...
    test "AR numbers should return correct value #11" do
    ...
    test "AR numbers should return correct value #12" do
    ...
    test "AR numbers should return correct value #13" do
    ...
    test "AR numbers should return correct value #14" do
      {result, phone_number} = parse("0 1187654321", RegionCodeFixture.ar())
    ...
    test "AR numbers should return correct value #15" do
    ...
    test "AR numbers should return correct value #16" do
    ...
    test "MX numbers should return correct value #1" do
    ...
    test "MX numbers should return correct value #2" do
    ...
    test "MX numbers should return correct value #3" do
    ...
    test "MX numbers should return correct value #4" do
    ...
    test "MX numbers should return correct value #5" do
    ...
    test "MX numbers should return correct value #6" do
    ...
    test "Number with alpha chars should return correct value #1" do
    ...
    test "Number with alpha chars should return correct value #2" do
    ...
    test "Number with alpha chars should return correct value #3" do
    ...
    test "Number with alpha chars should return correct value #4" do
    ...
    test "Number with alpha chars should return correct value #5" do
      {result, phone_number} = parse("0900 332 600A5", RegionCodeFixture.nz())
    ...
    test "Number with alpha chars should return correct value #6" do
    ...
    test "Number with international prefix should return correct value #1" do
    ...
    test "Number with international prefix should return correct value #2" do
    ...
    test "Number with international prefix should return correct value #3" do
    ...
    test "Number with international prefix should return correct value #4" do
    ...
    test "Number with international prefix should return correct value #5" do
    ...
    test "Number with international prefix should return correct value #6" do
    ...
    test "Number with international prefix should return correct value #7" do
    ...
    test "Number with international prefix should return correct value #8" do
    ...
    test "Non Ascii should return correct value #1" do
    ...
    test "Non Ascii should return correct value #2" do
      {result, phone_number} = parse("1 (650) 253\u00AD-0000", RegionCodeFixture.us())
    ...
    test "Non Ascii should return correct value #3" do
      {result, phone_number} =
        parse(
          "\uFF0B\uFF11\u3000\uFF08\uFF16\uFF15\uFF10\uFF09\u3000\uFF12\uFF15\uFF13\uFF0D\uFF10\uFF10\uFF10\uFF10",
    ...
    test "Non Ascii should return correct value #4" do
      {result, phone_number} =
        parse(
          "\uFF0B\uFF11\u3000\uFF08\uFF16\uFF15\uFF10\uFF09\u3000\uFF12\uFF15\uFF13\u30FC\uFF10\uFF10\uFF10\uFF10",
          RegionCodeFixture.sg()
    ...
    test "With Leading Zero should return correct value #1" do
    ...
    test "With Leading Zero should return correct value #2" do
    ...
    test "With Leading Zero should return correct value #3" do
    ...
    test "Invalid numbers should match the error message #1" do
    ...
    test "Invalid numbers should match the error message #2" do
    ...
    test "Invalid numbers should match the error message #3" do
    ...
    test "Invalid numbers should match the error message #5" do
    ...
    test "Invalid numbers should match the error message #6" do
    ...
    test "Invalid numbers should match the error message #7" do
      {result, message} = parse("+***", RegionCodeFixture.de())
    ...
    test "Invalid numbers should match the error message #8" do
    ...
    test "Invalid numbers should match the error message #9" do
    ...
    test "Invalid numbers should match the error message #10" do
    ...
    test "Invalid numbers should match the error message #11" do
    ...
    test "Invalid numbers should match the error message #12" do
    ...
    test "Invalid numbers should match the error message #13" do
    ...
    test "Invalid numbers should match the error message #14" do
    ...
    test "Invalid numbers should match the error message #15" do
    ...
    test "Invalid numbers should match the error message #16" do
      {result, message} = parse("0044", RegionCodeFixture.gb())
    ...
    test "Invalid numbers should match the error message #17" do
    ...
    test "Invalid numbers should match the error message #18" do
    ...
    test "Invalid numbers should match the error message #19" do
    ...
    test "Invalid numbers should match the error message #20" do
    ...
    test "Invalid numbers should match the error message #21" do
    ...
    test "Invalid numbers should match the error message #22" do
    ...
    test "Invalid numbers should match the error message #23" do
    ...
    test "With plus sign with no region should match the phone number #1" do
    ...
    test "With plus sign with no region should match the phone number #2" do
      {result, phone_number} = parse("\uFF0B64 3 331 6005", RegionCodeFixture.zz())
    ...
    test "With plus sign with no region should match the phone number #3" do
    ...
    test "With plus sign with no region should match the phone number #4" do
    ...
    test "With plus sign with no region should match the phone number #5" do
    ...
    test "With plus sign with no region should match the phone number #6" do
    ...
    test "With plus sign with no region should match the phone number #7" do
    ...
    test "With plus sign with no region should match the phone number #8" do
      {result, phone_number} = parse("  tel:03-331-6005;phone-context=+64", RegionCodeFixture.zz())
    ...
    test "With plus sign with no region should match the phone number #9" do
    ...
    test "Too short if national prefix stripped should match the phone number #1" do
    ...
    test "Too short if national prefix stripped should match the phone number #2" do
    ...
    test "Too short if national prefix stripped should match the phone number #3" do
    ...
    test "Too short if national prefix stripped should match the phone number #4" do
    ...
    test "Number with extension should match the phone number #1" do
    ...
    test "Number with extension should match the phone number #2" do
    ...
    test "Number with extension should match the phone number #3" do
    ...
    test "Number with extension should match the phone number #4" do
    ...
    test "Number with extension should match the phone number #5" do
    ...
    test "Number with extension should match the phone number #6" do
      {result, phone_number} = parse("1800 SIX FLAGS", RegionCodeFixture.us())
    ...
    test "Number with extension should match the phone number #7" do
    ...
    test "Number with extension should match the phone number #8" do
    ...
    test "Number with extension should match the phone number #9" do
    ...
    test "Number with extension should match the phone number #10" do
    ...
    test "Number with extension should match the phone number #11" do
    ...
    test "Number with extension should match the phone number #12" do
    ...
    test "Number with extension should match the phone number #13" do
      {result, phone_number} = parse("+44 2034567890 X456", RegionCodeFixture.gb())
    ...
    test "Number with extension should match the phone number #14" do
    ...
    test "Number with extension should match the phone number #15" do
      {result, phone_number} = parse("+44 2034567890 X  456", RegionCodeFixture.gb())
    ...
    test "Number with extension should match the phone number #16" do
      {result, phone_number} = parse("44 2034567890 x 456  ", RegionCodeFixture.gb())
    ...
    test "Number with extension should match the phone number #17" do
      {result, phone_number} = parse("+44 2034567890  X 456", RegionCodeFixture.gb())
    ...
    test "Number with extension should match the phone number #18" do
    ...
    test "Number with extension should match the phone number #19" do
    ...
    test "Number with extension should match the phone number #20" do
    ...
    test "Number with extension should match the phone number #21" do
    ...
    test "Number with extension should match the phone number #22" do
    ...
    test "Number with extension should match the phone number #28" do
    ...
    test "Number with extension should match the phone number #29" do
    ...
    test "Number with extension should match the phone number #30" do
    ...
    test "Number with extension should match the phone number #31" do
      {result, phone_number} = parse("(800) 901-3355;7246433", RegionCodeFixture.us())
    ...
    test "Number with extension should match the phone number #32" do
    ...
    test "Number with extension should match the phone number #33" do
    ...
    test "Number with extension should match the phone number #34" do
    ...
    test "Number with extension should match the phone number #35" do
      {result, phone_number} = parse("(800) 901-3355 , 7246433", RegionCodeFixture.us())
    ...
    test "Number with extension should match the phone number #36" do
      {result, phone_number} = parse("(800) 901-3355 ext: 7246433", RegionCodeFixture.us())
    ...
    test "Number with extension should match the phone number #23" do
    ...
    test "Number with extension should match the phone number #24" do
      {result, phone_number} = parse("(212)123-1234 x508/ x1234", RegionCodeFixture.us())
    ...
    test "Number with extension should match the phone number #25" do
      {result, phone_number} = parse("(212)123-1234 x508\\x1234", RegionCodeFixture.us())
    ...
    test "Number with extension should match the phone number #26" do
    ...
    test "Number with extension should match the phone number #27" do
    ...
    test "Italian leading zero should match the phone number #1" do
    ...
    test "Italian leading zero should match the phone number #2" do
    ...
    test "Italian leading zero should match the phone number #3" do
    ...
    test "Italian leading zero should match the phone number #4" do
